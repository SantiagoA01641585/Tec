...
#define WIFI_SSID "TP-LINK_1BF4"
#define WIFI_PASSWORD "52391675"

/* 2. Define the API Key */
#define API_KEY "AIzaSyDh8eDoRc8ST8TI133MaY-TK8rsRrInvHo"

/* 3. Define the project ID */
#define FIREBASE_PROJECT_ID "dog-e-6830c"
...
void loop()
{
    ...
    if (Firebase.ready() && (millis() - dataMillis > 60000 || dataMillis == 0))
    {
        ...
        String documentPath = "nuevo/b0" + String(count);
